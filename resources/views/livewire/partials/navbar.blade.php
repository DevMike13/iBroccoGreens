<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-transparent text-sm py-6 px-10 fixed">
    <nav class="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between">
      ...
      <div class="sm:order-3 flex items-center gap-x-2">
        ...
        <button type="button" class="py-2 px-3 uppercase inline-flex items-center gap-x-2 text-sm font-medium rounded-lg text-white shadow-sm hover:bg-blue-900 focus:outline-none  disabled:opacity-50 disabled:pointer-events-none">
          Login
        </button>
      </div>
